<template>
  <AdminLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">施設登録</h2>
    </template>
          ...
          <form @submit.prevent="submit" class="p-6 space-y-6">
            ...
            <div class="border-t border-gray-300 pt-4">
              ...
              <p class="text-xs text-gray-500 mt-1">
                ※ 社用車など一覧に出ないリソースは、メールアドレス（例: car1@akioka-ltd.jp）を直接入力してください。空欄の場合はOutlook連携なしになります。
              </p>
...
const form = useForm({
  name: '',
  outlook_resource_email: '',
});

// ドロップダウンで選んだ会議室をメールアドレス欄に反映
