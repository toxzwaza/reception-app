...
const form = useForm({
  department_name: props.phone.department_name,
  contact_person: props.phone.contact_person,
  phone_number: props.phone.phone_number,
  extension_number: props.phone.extension_number,
  notes: props.phone.notes,
  is_active: props.phone.is_active,
  display_order: props.phone.display_order,
});

const submit = () => {
  form.put(route('admin.interview-phones.update', props.phone.id));
};
</script>
