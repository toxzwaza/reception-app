  ...
  <ReceptionLayout title="面接の方" subtitle="担当者へ連絡中です">
    <div class="p-12">
      <div class="max-w-4xl mx-auto">
        <!-- 面接担当者への自動通話 -->
        <div v-if="interviewPhones && interviewPhones.length > 0" class="space-y-6">
          <TwilioAutoCall
        ...
        <!-- 面接用電話番号が登録されていない場合 -->
        <div v-else class="bg-white rounded-xl border-2 border-yellow-300 shadow-lg p-8 text-center">
