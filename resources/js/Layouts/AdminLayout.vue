...
const secondaryNavItems = [
    ...
    {
        label: '集荷依頼', route: 'admin.pickup-requests.index', pattern: 'admin.pickup-requests.*',
    ...
    {
        label: '担当者呼出', route: 'admin.staff-phones.index', pattern: 'admin.staff-phones.*',
    ...
    {
        label: '画面パターン', route: 'admin.screen-patterns.index', pattern: 'admin.screen-patterns.*',
